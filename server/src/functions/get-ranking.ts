...
export async function getRanking() {
    //pegando os primeiros 3 do ranking e suas pontuações
    const ranking = await redis.zrevrange('referral:ranking', 0, 2, 'WITHSCORES')
    
    //colocando o ranking como um objeto, id(chave): pontuação(valor)
    ...
    //buscar os dados do usuário que estão faltando no ranking
    ...
    .sort((sub1, sub2) => {
        return sub2.score - sub1.score  //ordenando de forma decrescente
    })
